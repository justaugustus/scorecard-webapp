...
func configureAPI(api *operations.ScorecardAPI) http.Handler {
	...
	api.GetResultHandler = operations.GetResultHandlerFunc(server.GetResultHandler)
	if api.PostResultHandler == nil {
		api.PostResultHandler = operations.PostResultHandlerFunc(func(params operations.PostResultParams) middleware.Responder {
			return middleware.NotImplemented("operation operations.PostResult has not yet been implemented")
		})
	}

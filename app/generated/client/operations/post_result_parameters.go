...
// WithPayload adds the payload to the post result params
func (o *PostResultParams) WithPayload(payload *models.Payload) *PostResultParams {
	o.SetPayload(payload)
	return o
}

// SetPayload adds the payload to the post result params
func (o *PostResultParams) SetPayload(payload *models.Payload) {
	o.Payload = payload
}
